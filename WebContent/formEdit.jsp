			...
			<div class="col-lg-9">
				...
				<div class="row">
					...
					<div class="container-fluid mt-3">
						<form id="add" action="AdminEditController">
							<div class="form-row">
								<div class="form-group col-sm-6">
									<label for="Item_ID">Item_ID</label> <input type="text"
										class="form-control" id="Item_ID" name="itemID" value="${EditItem.getItemID()}">
								</div>
								<div class="form-group col-sm-6">
									<label for="Item_Name">Item_Name</label> <input type="text"
										class="form-control" id="Item_Name" name="itemName" value="${EditItem.getItemName()}">
								</div>
							</div>
							<div class="form-group">
								<label for="file">Image</label> <input type="file"
									class="form-control" id="Image_Path" name="imagePath" value="${EditItem.getImagePath()}">
							</div>
							<div class="form-group">
								<label for="Prices">Prices</label> <input type="text"
									class="form-control" id="Prices" name="price" value="${EditItem.getCost()}">
							</div>
							<div class="form-row">
								<div class="form-group col-sm-6">
