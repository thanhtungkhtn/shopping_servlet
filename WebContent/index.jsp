		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<div id="carouselExampleIndicators" class="carousel slide my-4"
					...
					<div class="carousel-inner" role="listbox">
						<div class="carousel-item active">
							<img class="d-block img-fluid" src="assets/images/pic01.png"
								alt="First slide">
						</div>
				...
				<div class="row">
					...
					<!--${listitems.entrySet().stream().map(x -> 
					"--><div class='col-lg-4 col-md-6 mb-4'>
						<div class='card h-100'>
			              <a href='#'><img class='card-img-top' src='assets/images/" += x.getValue().getImagePath() += "'></a>
			              <div class='card-body'>
			              	<h4 class='card-title'>
			                  <a href='ItemInfoController?itemID="+= x.getValue().getItemID() +="'>"+= x.getValue().getItemName() += "</a>
			                </h4>
			                <h5>$"+= x.getValue().getCost() +="</h5>
			                <p class='card-text'>bla bla ...!</p>
			              </div>
			              <div class='card-footer'>
			                <small id='star' class='text-muted'>&#9733; &#9733; &#9733; &#9733; &#9734;</small>
			                <FORM id='add' ACTION='yourCart'>
			              	<INPUT TYPE='HIDDEN' NAME='itemID' VALUE='" += x.getValue().getItemID() +="'>
			              	<INPUT type='submit' name='btn' class='btn-style' VALUE='Add Cart'>
			              </FORM>
			              </div>			              
			            </div>
			          </div><!--").toList()}-->
